...
import { LogInCard, LogInButton, BackClick } from "./loginStyle";
        ...
        <>
            ...
            {logCard &&
                <>
                    ...
                    <LogInCard>
                        <form>
                            <p>Sign in the NASA Project</p>
                            <input type="text" name="nameUser" id="nameUser" placeholder="Username" onChange={saveData} value={user.name} />
